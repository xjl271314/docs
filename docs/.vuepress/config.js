  ...
  head: [
    ...
    [
      "script",
      {
        ...
        src:
          "https://cdn.jsdelivr.net/gh/bmob/hydrogen-js-sdk/dist/Bmob-2.2.4.min.js",
      },
    ],
  ],
  markdown: {
  ...
  themeConfig: {
    ...
    sidebar: [
      ...
      "/http/",
      {
        title: "浏览器相关知识",
        collapsable: true,
        children: ["/browser/extension", "/browser/knowledge", "/browser/cors"],
      },
      {
        title: "PS相关知识",
        collapsable: true,
      ...
      },
      {
        title: "nginx",
        collapsable: true,
        children: ["/nginx/base", "/nginx/https"],
      },
      {
        title: "TypeScript",
        collapsable: true,
      ...
      },
      {
        title: "Vue",
        collapsable: true,
        children: ["/vue/lifestyle", "/vue/scoped"],
      },
      {
        title: "Electron",
        collapsable: true,
        children: ["/electron/build", "/electron/update"],
      },
      {
        title: "Mysql",
        collapsable: true,
      ...
      },
      {
        title: "Redis",
        collapsable: true,
        children: ["/redis/base", "/redis/notification", "/redis/multy"],
      },
      "/bff/",
      {
        title: "开放性问题",
      ...
      },
      {
        title: "即时通讯",
        collapsable: true,
        children: ["/im/tcent", "/im/base"],
      },
      {
        title: "算法",
        collapsable: true,
        children: ["/algorithm/cacheLRU"],
      },
      {
        title: "LeetCode",
        collapsable: true,
